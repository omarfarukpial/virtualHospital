...
"https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js">
    ...
    <title>Service Delivery System Form</title>
...
<body>
    ...
    <div class="dform" style="width:40%">
        ...
        <label for="sdoctor">Doctor</label>
        <select name="sdoctor" id="sdoctor" onchange="showUser(this.value)">
...
<script>
        function inputvalsds(username) {
            if (username.length == 0) {
                ...
                if (this.readyState==4 && this.status==200) {
                    ...
                    document.getElementById("phn").value=myobj[3];
                    document.getElementById("cloc").value=myobj[4];
                    }
                }
        ...
        xmlhttp.open("GET","sdsuserfill.php?username="+username,true);
        xmlhttp.send();
        }
    </script>
