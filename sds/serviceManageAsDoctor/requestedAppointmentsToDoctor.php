...
overflow: hidden;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
    ...
    <?php
        ...
        $sql = "SELECT appointmentrequest.appointmentrequest_id as apt_id,  doctor.id as d_id, doctor.name as d_name, doctor.specialization as d_sp, doctor.fees as d_fees, userinfo.id as u_id, userinfo.name as u_name, userinfo.location as u_loc, userinfo.phone as u_phn, appointmentrequest.problem as apt_prob, appointmentrequest.appointmenttime as apt_time, appointmentrequest.status as apt_status, appointmentrequest.doctorid as apt_did, appointmentrequest.finished as apt_finished
