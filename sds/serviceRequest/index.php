...
<section id="news" class="d-flex justify-content-between ml-2 mr-2">
    ...
    <div>
        <h1 class="text-center header-font mt-4"> Request <span class="p-text">For Service</span> </h1>
    </div>
    <div>
...
<!-- Center button -->
 <div class="mt-5">
    <div class = "d-flex justify-content-center">
        <button  type="button" class="btn-add w-25 p-4"  onclick="location.href = 'doctorAppointment' ">Doctor Appointment</button>
    </div>
