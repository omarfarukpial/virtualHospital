...
?>
    ...
    <div style="display:flex">
      ...
      <div class="descontent">
        ...
        <img src="img/bloodbankicon.jpg" alt="Blood bank logo" height=150px width=150px style="border-radius: 50%;">
        </div>
        
        <br>
        <h5>A blood bank is a place where blood is collected and stored before it is used for transfusions. Blood banking takes place in the lab. This is to make sure that donated blood and blood products are safe before they are used. Blood banking also determines the blood type. </h5>
