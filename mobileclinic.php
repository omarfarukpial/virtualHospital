...
?>
    ...
    <section id="news" class="container my-5 pt-4">
        <h1 class="text-center header-font my-5"> Mobile Clinics <span class="p-text">List</span> </h1>
    </section>
    ...
    <div class="row" style="margin-left: 10%; margin-right:10%">
        ...
        <div class="col-md-6 text-right">
            <a href="MobileClinicForm.php">
                <button type="button" class="addB">Add Mobile Clinic</button>
            </a>
        </div>
    ...
    overflow: hidden;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            ...
            <?php
                ...
                $sql = "SELECT * FROM mobileclinicform";
