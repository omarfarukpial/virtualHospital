...
?>
    ...
    <section id="news" class="container pt-4">
        <h1 class="text-center header-font mt-4"> Mobile Oxygen <span class="p-text">Delivery Service</span> </h1>
    </section>
    ...
    <div class="row" style="margin-left: 10%; margin-right:10%">
        ...
        <div style="margin-left:1030px" class="container">
            <a href="modsForm.php">
                <button type="button" class="addB">Add MODS</button>
            </a>
        </div>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td align=right>". $row["id"]. "</td>".
                            "<td>". $row["modsname"]. "</td>" .
                            "<td align=right>". number_format($row["oxygenprice"],2). "</td>" .
