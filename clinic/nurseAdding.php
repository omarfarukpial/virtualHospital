...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  // collect value of input field
    ...
    foreach($docidlist as $docidlist){ 
        $docAddSql = "INSERT INTO clinicnurselist (nurse_id, clinic_id)
    ...
    header("Location:./nurseList.php?cid=$clinicid&cname=$clinicname");
...
<div>
        ...
        <div>
        <h1 class="text-center text-white header-font mt-4"> Add Nurse</h1>
        </div>
        <div>
...
// SELECT * FROM demo_table1 WHERE NAME NOT IN (SELECT NAME FROM demo_table2);
                ...
                $sql = "SELECT * FROM nurse WHERE id NOT IN (SELECT nurse_id FROM clinicnurselist WHERE clinic_id = $cid)";
