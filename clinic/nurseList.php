...
<meta charset="UTF-8">
    ...
    <title>Nurse List in Clinic</title>
...
<section id="news" class="container-xxl d-flex justify-content-between mb-4 rounded bg-info shadow">
    ...
    <div>
    <a href="nurseAdding.php"><button type="button" class="btn-add">Add Nurse</button></a>
    </div>

        <div>
        <h1 class="text-center text-white header-font mt-4">  Nurses in <?php echo $clinicname ?> </h1>
    ...
    overflow: hidden;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            ...
            <?php
                ...
                $sql = "SELECT * FROM clinicnurselist
                        WHERE clinic_id = $cid
                        ";
